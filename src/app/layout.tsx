...
export default function RootLayout({ children }: { children: React.ReactNode }) { return <html lang="pt" suppressHydrationWarning><body className={`${geist.variable} antialiased`}><PwaProvider>{children}</PwaProvider><Toaster position="top-center" richColors closeButton /></body></html>; }
